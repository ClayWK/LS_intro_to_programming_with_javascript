...
// we want to use the map function to create a new array that contains one element 
// for each element in the original array. If the element is an even value, then the 
